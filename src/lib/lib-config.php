...
class config {
  ...
  private $debug = false;
  private $templateFiles = "/twig";
  private $phpFiles = "/php";
  ...
  public function load($includeAppConfig=true, $loadTwig=true){
    ...
    { 
      ...
      if($includeAppConfig === false){
        ...
        require_once $this->root . $this->phpFiles . "/main.php";
      }else{
  ...
  public function destroy() {
    self::rrmdir($this->root . $this->templateFiles . "/lib");
  }
  ...
  private function loadTwig () {
    //move templates over
    self::copy_directory($this->root."/lib/TwigTemplates", $this->root . $this->templateFiles . "/lib");
    
    require_once $this->root."/lib/Twig/Autoloader.php";
    Twig_Autoloader::register();
    $loader = new Twig_Loader_Filesystem($this->root . $this->templateFiles);
